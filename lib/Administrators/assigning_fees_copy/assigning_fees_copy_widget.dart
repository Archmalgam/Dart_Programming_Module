...
import 'assigning_fees_copy_model.dart';
export 'assigning_fees_copy_model.dart';

class AssigningFeesCopyWidget extends StatefulWidget {
  const AssigningFeesCopyWidget({super.key});

  @override
  State<AssigningFeesCopyWidget> createState() =>
      _AssigningFeesCopyWidgetState();
}

class _AssigningFeesCopyWidgetState extends State<AssigningFeesCopyWidget> {
  late AssigningFeesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssigningFeesCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<StudentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<StudentsRecord> assigningFeesCopyStudentsRecordList =
            snapshot.data!;
                                        ...
                                        child: Container(
                                          ...
                                          child: Autocomplete<String>(
                                            ...
                                            optionsBuilder: (textEditingValue) {
                                              ...
                                              return assigningFeesCopyStudentsRecordList
                                                  .map((e) => e.studentName)
                                                  .toList()
                                                  .where((option) {
                                                  ...
                                                  () async {
                                                    safeSetState(() {
                                                      _model.simpleSearchResults =
                                                          TextSearch(
                                                        assigningFeesCopyStudentsRecordList
                                                            .map(
                                                              (record) =>
                                                                  TextSearchItem
                                                                      .fromTerms(
                          ...
                          if (_model.studentDocuments.isNotEmpty) {
                            if (_model.textController2.text != null &&
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Fee amount must be entered!'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                            Navigator.pop(alertDialogContext),
